            ...
            dbc.Row(
                [
                    ...
                    dbc.Col(
                        [
                            dcc.Markdown(
                                "Adam is very professional. I really appreciate his quick thinking "
            ...
            dbc.Row(
                [
                    ...
                    dbc.Col(
                        [
                            dcc.Markdown(
                                "Adam is so good with the ball. Every time he has the ball, I can see the stadium rise to its feet."
            ...
            dbc.Row(
                [
                    ...
                    dbc.Col(
                        [
                            dcc.Markdown(
                                "I feel so lucky to have a teammate like Adam on my team. People talk about Messi all the time "
