        ...
        [
            dbc.Col(
                [
                    ...
                    dcc.Markdown(
                        "[www.linkedin.com/in/adam-schroeder-17b5a819/](https://www.linkedin.com/in/adam-schroeder-17b5a819/)",
                        link_target="_blank",
                    ),
                    dcc.Markdown("YouTube", style=green_text),
                    dcc.Markdown(
                        "[www.youtube.com/charmingdata](https://www.youtube.com/charmingdata)",
                        link_target="_blank",
                    ),
                ],
