...
layout = html.Div(
    [
        ...
        html.Hr(),
        dcc.Markdown(
            "Highly motivate Sales Associate with extensive customer service and sales experience. \n"
        ...
        dbc.Row(
            [
                dbc.Col(
                    [dcc.Markdown("06/2017 to 03/2018", style={"textAlign": "center"})],
                    width=2,
                ),
                dbc.Col(
                    [
        ...
        dbc.Row(
            [
                dbc.Col([dcc.Markdown("2013", style={"textAlign": "center"})], width=2),
                dbc.Col(
                    [
                        dcc.Markdown(
